...
class SiteOpsTests(unittest.TestCase):
    ...
    def test_autolister_offer_is_the_script_based_499_monthly_plan(self):
        ...
        self.assertIn('href="https://square.link/u/MlGY1OMG"', offer)
        self.assertIn("Subscribe for $499/month", offer)
        self.assertIn("Payment starts onboarding; it does not automatically activate inventory or publish listings.", offer)
